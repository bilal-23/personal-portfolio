    ...
    return (
        <Section className={classes.background}>
            ...
            <div className={classes.background_content}>
                ...
                <p>As a frontend developer, I enjoy learning new frameworks and libraries. Recently I have studied Next.js which is a react framework. When developing web-apps I aim for a beautiful, responsive and pixel-perfect user experience.</p>
